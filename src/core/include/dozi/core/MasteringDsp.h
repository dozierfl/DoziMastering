...
struct CompressorSettings { bool bypassed=false; double thresholdDbfs=-18, ratio=1.5, attackMs=30, releaseMs=150, makeupGainDb=0; };
struct LimiterSettings { bool bypassed=false; double inputGainDb=0, ceilingDbtp=-1, lookaheadMs=5, releaseMs=100; };
...
struct MultibandCompressorSettings {
    bool bypassed=false;
    double lowCrossoverHz=160, highCrossoverHz=4000;
    MultibandCompressorBandSettings low, mid, high;
};
enum class SaturationMode { tape, tube };
